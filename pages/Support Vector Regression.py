...
y_pred_SVR = loaded_model.predict(X_test)


st.subheader('Graph of using SVR Model')
...
plt.title('SVR forecasting for  Stock Price ')
plt.legend()
st.pyplot(fig)
